...
## git update-index --assume-unchanged $HOME/.config/baptize.sh
#source $HOME/.config/baptize.sh
#
...
## defaults write com.apple.universalaccess.plist 'mouseDriverCursorSize' 1.5
