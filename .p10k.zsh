# Generated by Powerlevel10k configuration wizard on 2024-02-25 at 13:39 PST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RULER_CHAR=''         # reasonable alternative: '·' # unset for warp terminal
  ...
  typeset -g POWERLEVEL9K_VCS_DISABLE_GITSTATUS_FORMATTING=true #KG - false
